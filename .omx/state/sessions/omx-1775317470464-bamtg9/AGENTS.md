...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775317470464-bamtg9 | 2026-04-04T15:44:30.922Z

**Codebase Map:**
  apps/: postcss.config, App, AdminLayout, Header, Sidebar, avatar, badge, button, card, dialog
  packages/: drizzle.config, client, repository, schema, seed, sqlite, test-db, schema-smoke.test, session-schema.test
